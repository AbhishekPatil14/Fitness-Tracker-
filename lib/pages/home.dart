            ...
            children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              "Squats",
                              style: AppWidget.mediumTextstyle(22),
                            ),
                            SizedBox(height: 5),
                            Row(
                              children: [
              ...
              Container(
                ...
                child: Material(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  child: Container(
                    padding: EdgeInsets.fromLTRB(30, 12, 0, 8),
                    decoration: BoxDecoration(
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(10),
                    ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.alarm, color: Color(0xff6358e1)),
                                  SizedBox(width: 5),
                                  Text(
                                    "12:00",
                                    style: TextStyle(
                    ...
                    child: Row(
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Arams", style: AppWidget.mediumTextstyle(22)),
                            SizedBox(height: 5),
                            Text(
                              "4 sets | 30 Repetition",
                              style: TextStyle(
                                color: Color.fromARGB(147, 0, 0, 0),
                                fontSize: 18,
                                fontWeight: FontWeight.w500,
